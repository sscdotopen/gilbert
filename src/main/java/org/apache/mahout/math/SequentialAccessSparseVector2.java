 ...
 */
public class SequentialAccessSparseVector2 extends AbstractVector2 implements KryoSerializable, Serializable {

  private OrderedIntDoubleMapping values;

  /** For serialization purposes only. */
  public SequentialAccessSparseVector2() {
    super();
  }

  public SequentialAccessSparseVector2(int cardinality) {
    this(cardinality, Math.min(100, cardinality / 1000 < 10 ? 10 : cardinality / 1000)); // arbitrary estimate of
                                                                                           // 'sparseness'
  }

  public SequentialAccessSparseVector2(int cardinality, int size) {
    super(cardinality);
    values = new OrderedIntDoubleMapping(size);
  }

  public SequentialAccessSparseVector2(Vector other) {
  ...
  public SequentialAccessSparseVector2(SequentialAccessSparseVector2 other, boolean shallowCopy) {
    super(other.size());
    values = shallowCopy ? other.values : other.values.clone();
  }

  public SequentialAccessSparseVector2(SequentialAccessSparseVector2 other) {
    this(other.size(), other.getNumNondefaultElements());
    values = other.values.clone();
  }

  private SequentialAccessSparseVector2(int cardinality, OrderedIntDoubleMapping values) {
    super(cardinality);
    this.values = values;
  }
  ...
  @Override
  public SequentialAccessSparseVector2 clone() {
    return new SequentialAccessSparseVector2(size(), values.clone());
  }
  ...
  @Override
  public SequentialAccessSparseVector2 like() {
    return new SequentialAccessSparseVector2(size(), values.getNumMappings());
  }
  ...
  public void read(Kryo kryo, Input input) {
    values = kryo.readObject(input, OrderedIntDoubleMapping.class);
  }
  ...
  private final class AllIterator implements Iterator<Element> {
    ...
    @Override
    public boolean hasNext() {
      return element.getNextIndex() < SequentialAccessSparseVector2.this.size();
    }

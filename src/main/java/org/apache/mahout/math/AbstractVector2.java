...
public abstract class AbstractVector2 implements Vector, LengthCachingVector, KryoSerializable, Serializable {
  ...
  protected AbstractVector2(int size) {
    this.size = size;
  }
  ...
  public Iterable<Vector.Element> all() {
    return new Iterable<Element>() {
      ...
      public Iterator<Element> iterator() {
        return AbstractVector2.this.iterator();
      }
    };
  }
  ...
  public Vector clone() {
    try {
      AbstractVector2 r = (AbstractVector2) super.clone();
      r.size = size;

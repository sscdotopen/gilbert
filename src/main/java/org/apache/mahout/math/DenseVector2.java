...
public class DenseVector2 extends AbstractVector2 implements Serializable, KryoSerializable {
  ...
  public DenseVector2(double[] values) {
    this(values, false);
  }

  public DenseVector2(double[] values, boolean shallowCopy) {
    super(values.length);
    this.values = shallowCopy ? values : values.clone();
  }

  public DenseVector2(DenseVector2 values, boolean shallowCopy) {
    this(values.values, shallowCopy);
  }

  /** Construct a new instance of the given cardinality */
  public DenseVector2(int cardinality) {
    super(cardinality);
   ...
   */
  public DenseVector2(Vector vector) {
    super(vector.size());
  ...
  @Override
  public DenseVector2 clone() {
    return new DenseVector2(values.clone());
  }
  ...
  @Override
  public DenseVector2 like() {
    return new DenseVector2(size());
  }
  ...
  public Vector assign(DenseVector2 vector) {
  ...
  public boolean equals(Object o) {
    if (o instanceof DenseVector2) {
      // Speedup for DenseVectors
      return Arrays.equals(values, ((DenseVector2) o).values);
    }
  ...
  public void read(Kryo kryo, Input input) {
    values = kryo.readObject(input, double[].class);
  }

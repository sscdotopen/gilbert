...
class GilbertShell extends ILoop {
  ...
  addThunk {
    intp.beQuietDuring {
      intp.addImports("io.ssc.gilbert2._")
      intp.addImports("io.ssc.gilbert2.runtime._")
      intp.addImports("io.ssc.gilbert2.runtime.local._")
      intp.addImports("io.ssc.gilbert2.shell._")
    }
  }
